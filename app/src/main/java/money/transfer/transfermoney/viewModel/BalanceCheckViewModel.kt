...
class BalanceCheckViewModel: ViewModel(){
    ...
    internal fun moneyTransfer(amount: String) {
        networkRequest.request(NetworkAPI.TRANSFER_MONEY_API, NetworkRequest.Method.POST, NetworkAPI.getBalancePostBody(dataEncryption.encryptData(amount, BuildConfig.dataPublic) ).toString(),
